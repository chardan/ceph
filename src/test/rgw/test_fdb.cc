...
TEST_CASE("fdb simple", "[rgw][fdb]") {
 ...
 /* JFW: The first and perhaps most straightforward way of interacting with FDB is through
 ...
 pointer kind of interface). Then you have to figure out how you want to manage transactions--
 a more "ergonomic" interface will be provided, but right now this is a comparatively manual
 process meant to allow visibility, control, and reliability as I work on understanding
 FDB's model more completely:
 */
